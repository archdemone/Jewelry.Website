...
// Each image is carefully selected to be different and relevant to jewelry/rings
const IMAGE_MAPPING = {
  ...
  'modern-three-stone-ring-2.jpg': 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&h=800&fit=crop&crop=center&q=80',
...
async function downloadAllImages() {
  console.log('🚀 Starting diverse image download...');
  ...
  if (errorCount === 0) {
    console.log('🎉 All diverse images downloaded successfully!');
  } else {

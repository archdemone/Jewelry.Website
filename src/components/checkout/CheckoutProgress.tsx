          ...
          return (
            <React.Fragment key={step.id}>
              ...
              <div className="flex flex-col items-center">
                ...
                {isCurrent && (
                  <motion.div
                    className="absolute -bottom-1 w-4 h-1 bg-gold-500 rounded-full"              initial={{ scaleX: 0 }}              animate={{ scaleX: 1 }}              transition={{ duration: 0.3 }}
                  />
                )}
              </div>
              ...
              {index < steps.length - 1 && (
                <div className="flex-1 mx-4">
                  <div className="relative h-0.5 bg-gray-200">
                    <motion.div
                      className="absolute top-0 left-0 h-full bg-gold-500"              initial={{ scaleX: 0 }}              animate={{ 

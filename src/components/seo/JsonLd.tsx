...
export function ArticleJsonLd({ article }: { article: { title: string; slug: string; date: string; image?: string; author?: string } }) {
	const schema = {
		'@context': 'https://schema.org',
		'@type': 'Article',
...
export function ReviewJsonLd({ review }: { review: { rating: number; title?: string; comment: string; author?: string; date?: string } }) {
	const schema = {
		'@context': 'https://schema.org',
		'@type': 'Review',
		reviewRating: {

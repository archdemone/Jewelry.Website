	...
	return (
		<footer className="border-t bg-white">
			<div className="container grid gap-8 py-10 md:grid-cols-4">
				<div>
					<h3 className="font-[var(--font-serif)] text-lg font-semibold text-secondary">Aurora Jewelry</h3>
				...
				<div>
					...
					<ul className="mt-3 space-y-2 text-sm">
						...
						<li><Link href="/(shop)/products" className="hover:underline">Shop</Link></li>
						<li><Link href="/(shop)/about" className="hover:underline">About</Link></li>
			...
			<div className="border-t py-4 text-center text-xs text-gray-600">© {new Date().getFullYear()} Aurora Jewelry. All rights reserved.</div>
		</footer>
	);
}

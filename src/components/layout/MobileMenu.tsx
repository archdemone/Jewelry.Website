              ...
              <div className="px-4 py-3 border-b border-gray-50">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Link href="/products/mens"
                    className="block px-3 py-2 text-sm text-gray-700 bg-gray-50 rounded-lg transition-colors hover:bg-gray-100 hover:text-gold-600" onClick={handleMenuToggle}
                  ...
                  <Link href="/products/wedding"
                    className="block px-3 py-2 text-sm text-gray-700 bg-gray-50 rounded-lg transition-colors hover:bg-gray-100 hover:text-gold-600" onClick={handleMenuToggle}
                    aria-label="Browse wedding rings"
                  >
                    Wedding Rings
                  </Link>
                  <Link href="/products/engagement"
                    className="block px-3 py-2 text-sm text-gray-700 bg-gray-50 rounded-lg transition-colors hover:bg-gray-100 hover:text-gold-600" onClick={handleMenuToggle}
                    aria-label="Browse engagement rings"
                  >
                    Engagement Rings
                  </Link>
                  <Link href="/products/inlay"
                    className="block px-3 py-2 text-sm text-gray-700 bg-gray-50 rounded-lg transition-colors hover:bg-gray-100 hover:text-gold-600" onClick={handleMenuToggle}
                    aria-label="Browse inlay rings"
                  >
                    Inlay Rings
                  </Link>
                  <Link href="/products/statement"
                    className="block px-3 py-2 text-sm text-gray-700 bg-gray-50 rounded-lg transition-colors hover:bg-gray-100 hover:text-gold-600" onClick={handleMenuToggle}

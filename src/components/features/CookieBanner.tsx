...
export default function CookieBanner() {
	...
	function remember(choice: { type: 'accept_all' | 'reject_all' | 'custom'; prefs?: CookiePreferences }) {
		try { localStorage.setItem('cookie_consent_choice', JSON.stringify(choice)) } catch {}
		setVisible(false)
	}

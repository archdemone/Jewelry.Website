  ...
  return (
    <section className="bg-gray-50 py-20">
      <div className="container">
        ...
        >
          <h2 className="mb-4 font-serif text-4xl">Ring Collections</h2>
        ...
        >
          <Link
            href="/products"
            className="inline-block rounded-full border-2 border-gold-500 px-8 py-4 font-medium text-gold-500 transition-all duration-300 hover:scale-105 hover:bg-gold-500 hover:text-white"
          >

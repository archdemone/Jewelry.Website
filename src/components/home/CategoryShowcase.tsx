  ...
  const categories = [
    {
      ...
      image: '/images/categories/mensrings/mensrings.jpg',
    ...
    },
    {
      ...
      image: '/images/categories/womensrings/womensrings.jpg',
    ...
    },
    {
      ...
      image: '/images/categories/unisexrings/unisexrings.jpg',
    ...
    },
    {
      ...
      image: '/images/categories/weddingrings/weddingrings.jpg',
    ...
    },
    {
      ...
      image: '/images/categories/engagementrings/engagementrings.jpg',
    ...
    },
    {
      ...
      image: '/images/categories/inlayrings/inlay.jpg',
    ...
    },
    {
      ...
      image: '/images/categories/statementrings/statementrings.jpg',
    ...
    },
    {
      ...
      image: '/images/categories/allrings/allrings.jpg',
              ...
              <Link href={category.href} className="block h-full">
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <div className="absolute top-4 left-1/2 transform -translate-x-1/2">
                    <span className="rounded-full bg-black/70 backdrop-blur-sm px-4 py-2 text-sm font-semibold text-orange-400 shadow-lg">
                      {category.name}
                    </span>
                  </div>
                  {category.featured && (

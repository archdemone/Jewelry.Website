  ...
  return (
    <main className="space-y-0">
        ...
        <section className="relative h-[60vh] min-h-[500px] overflow-hidden bg-gradient-to-br from-amber-50 to-orange-50">
              ...
              <Image src="/images/process/workshop-hero.jpg"
        ...
        <section className="bg-gray-50 py-16">
              ...
              <Image src="/images/process/material-selection.jpg"
              ...
              <Image src="/images/process/crafting-action.jpg"
              ...
              <Image src="/images/process/final-polish.jpg"

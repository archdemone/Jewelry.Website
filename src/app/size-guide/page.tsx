		...
		<>
			...
			<main className="container py-10">
				<section className="mx-auto max-w-3xl">
					<h1 className="font-[var(--font-serif)] text-3xl font-semibold text-secondary">Size Guide</h1>
					<p className="mt-2 text-sm text-gray-600">Find your perfect fit with our ring, bracelet, and necklace sizing tips.</p>
					<div className="mt-6">
						<SizeChart />
					</div>
					<div className="mt-8 rounded-md border p-4">
						...
						<div className="mt-3 text-sm text-secondary"><a href="/files/ring-sizer.pdf" className="underline">Download printable ring sizer (PDF)</a></div>
					</div>
				</section>
			</main>
			<Footer />

...
export const metadata: Metadata = {
	...
	description: 'Discover our story, mission, values, and craftsmanship behind timeless fine jewelry.',
}
			...
			<main className="container px-4 md:px-6">
				<section className="py-12 md:py-20">
					<div className="mx-auto max-w-5xl text-center">
						<h1 className="font-[var(--font-serif)] text-4xl font-bold">Crafting Timeless Elegance</h1>
						<p className="mx-auto mt-3 max-w-2xl text-base leading-relaxed text-gray-600">Our jewelry is designed to celebrate life’s most meaningful moments—crafted ethically with uncompromising quality.</p>
				...
				<section className="py-12 md:py-20">
					<div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2">
						<div>
							...
							<p className="mt-2 text-base leading-relaxed text-gray-700">Founded in 2010, Aurora began as a small studio dedicated to responsible craftsmanship. Today, we serve customers worldwide while staying true to our roots.</p>
							<p className="mt-2 text-base leading-relaxed text-gray-700">From sketch to finished piece, we obsess over every detail.</p>
						</div>
				...
				<section className="py-12 md:py-20">
					<div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-3">
						<div>
							...
							<p className="mt-2 text-base leading-relaxed text-gray-700">To craft meaningful pieces that last a lifetime.</p>
						</div>
						<div>
							<h3 className="text-2xl font-semibold">Values</h3>
							<p className="mt-2 text-base leading-relaxed text-gray-700">Integrity, sustainability, transparency, and artistry.</p>
						</div>
						<div>
							<h3 className="text-2xl font-semibold">Craftsmanship</h3>
							<p className="mt-2 text-base leading-relaxed text-gray-700">Every piece passes through skilled hands and rigorous quality checks.</p>
						</div>
					</div>
				</section>
				...
				<section className="py-12 md:py-20">
					<div className="mx-auto max-w-5xl text-center">
						...
						<div className="mt-8">
							<a href="/products" className="inline-block rounded-md bg-black px-6 py-3 text-white">Shop the Collection</a>
						</div>
					</div>
				</section>
			</main>

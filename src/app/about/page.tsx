...
export default function AboutPage() {
  ...
  const timeline = [
    {
      year: '2020',
      title: 'Passion Project Begins',
      description: 'Started crafting jewelry as a hobby in a small home workshop'
    },
    {
      year: '2021',
      title: 'First Commission',
      description: 'Received first custom order from a friend'
    },
    {
      year: '2022',
      title: 'Word of Mouth Growth',
      description: 'Business grew through recommendations and local support'
    },
    {
      year: '2023',
      title: 'Council Approval',
      description: 'Obtained full business license and council approval'
    },
    {
      year: '2024',
      title: 'Established Business',
      description: 'Now a thriving local business serving the community'
    }
  ];
        ...
        <section className="relative h-[60vh] min-h-[500px] overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="relative z-10 flex h-full items-center justify-center">
            <div className="text-center text-white">
              <h1 className="text-5xl font-[var(--font-serif)] font-bold mb-4">
                About J&M
              </h1>
        ...
        <section className="py-16 bg-gradient-to-br from-gold-50 to-amber-50">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/products">
                <button className="bg-gold-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-gold-700 transition-colors flex items-center justify-center">
                  View Collection
                  <ArrowRight className="ml-2 h-4 w-4" />
                </button>
              </Link>
              <Link href="/contact">
                <button className="border-2 border-gold-600 text-gold-600 px-8 py-3 rounded-lg font-semibold hover:bg-gold-600 hover:text-white transition-colors flex items-center justify-center">
                  Get in Touch

  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-4">
              ...
              <Input placeholder="Search featured products..."
            value={query}
      ...
      {isAddingNew && (
        <Card className="p-6">
            ...
            />
              <Input placeholder="Original Price (optional)"
            ...
            />
              <select className="rounded-lg border border-gray-300 px-3 py-2" value={newProduct.material || ''} onChange={(e) => setNewProduct({ ...newProduct, material: e.target.value })}
            >
              ...
              <select className="rounded-lg border border-gray-300 px-3 py-2" value={newProduct.gemColor || ''} onChange={(e) => setNewProduct({ ...newProduct, gemColor: e.target.value })}
            >
              ...
              <select className="rounded-lg border border-gray-300 px-3 py-2" value={newProduct.category || ''} onChange={(e) => setNewProduct({ ...newProduct, category: e.target.value })}
            >
              ...
              <Input placeholder="Image Path (e.g., /images/MyImages/IMG-20250816-WA0000.jpg)" value={newProduct.image || ''} onChange={(e) => setNewProduct({ ...newProduct, image: e.target.value })}
            />
            ...
            />
              ...
              <input type="checkbox" checked={newProduct.isReadyToShip || false} onChange={(e) => setNewProduct({ ...newProduct, isReadyToShip: e.target.checked })}
              />
      ...
      {editingProduct && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            ...
            <div className="flex h-[calc(90vh-140px)] overflow-hidden">
              ...
              <div className="h-10 w-10 rounded-full border-2 border-gray-200 shadow-sm" style={{ backgroundColor: getGemColorHex(color) }}
                            />
              ...
              <input type="number" value={editingProduct.originalPrice || ''} onChange={(e) => setEditingProduct({ ...editingProduct, originalPrice: Number(e.target.value) || undefined })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"

      ...
      {isAddingNew && (
        <Card className="p-6">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Input
              placeholder="Price"
              type="number" value={newProduct.price || ''} onChange={(e) => setNewProduct({ ...newProduct, price: Number(e.target.value) })}
            />
            <Input
              placeholder="Original Price (optional)"
              type="number" value={newProduct.originalPrice || ''} onChange={(e) =>
                setNewProduct({ ...newProduct, originalPrice: Number(e.target.value) || undefined })
              }
            />
            <select
              className="rounded-lg border border-gray-300 px-3 py-2" value={newProduct.material || ''} onChange={(e) => setNewProduct({ ...newProduct, material: e.target.value })}
            >
            ...
            <select
              className="rounded-lg border border-gray-300 px-3 py-2" value={newProduct.gemColor || ''} onChange={(e) => setNewProduct({ ...newProduct, gemColor: e.target.value })}
            >
            ...
            <select
              className="rounded-lg border border-gray-300 px-3 py-2" value={newProduct.category || ''} onChange={(e) => setNewProduct({ ...newProduct, category: e.target.value })}
            >
            ...
            <Input
              placeholder="Image Path (e.g., /images/MyImages/IMG-20250816-WA0000.jpg)" value={newProduct.image || ''} onChange={(e) => setNewProduct({ ...newProduct, image: e.target.value })}
            />
            <Textarea
            ...
            <div className="flex items-center gap-2">
              <input
                type="checkbox" checked={newProduct.isReadyToShip || false} onChange={(e) => setNewProduct({ ...newProduct, isReadyToShip: e.target.checked })}
              />
                ...
                <div>
                  ...
                  <div className="mb-2 flex items-center gap-2">
                    <div className="flex text-yellow-400">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className={`h-3 w-3 ${i < Math.floor(product.rating) ? 'fill-current' : 'fill-gray-300'}`}
                        />
                      ))}
                    </div>
            ...
            <div className="flex h-[calc(90vh-140px)] overflow-hidden">
              ...
              <div className="w-1/3 p-6 border-r bg-gray-50 overflow-y-auto">
                ...
                <div className="mb-6">
                  <div className="relative aspect-square bg-white rounded-lg border-2 border-dashed border-gray-300 overflow-hidden">
                    {editingProduct.image ? (
                      <Image src={editingProduct.image} alt={editingProduct.name}
                        fill
                        className="object-cover"
                ...
                <div>
                  ...
                  <input
                    type="text" value={editingProduct.image || ''} onChange={(e) => setEditingProduct({ ...editingProduct, image: e.target.value })}
              ...
              <div className="w-2/3 p-6 overflow-y-auto">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      type="text" value={editingProduct.sku} onChange={(e) => setEditingProduct({ ...editingProduct, sku: e.target.value })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {availableGemColors.map((color) => (
                        <button key={color}
                          type="button" onClick={() => setEditingProduct({ ...editingProduct, gemColor: color })} onMouseEnter={() => setHoveredGemColor(color)} onMouseLeave={() => setHoveredGemColor(null)} className={`relative rounded-lg border-2 p-4 transition-all hover:shadow-md ${editingProduct.gemColor === color
                        ...
                        >
                          <div className="flex flex-col items-center gap-3">
                            <div
                              className="h-10 w-10 rounded-full border-2 border-gray-200 shadow-sm" style={{ backgroundColor: getGemColorHex(color) }}
                            />
                          ...
                          {hoveredGemColor === color && (
                            <div className="absolute bottom-full left-1/2 z-10 mb-3 -translate-x-1/2 transform">
                              <div className="rounded-lg border bg-white p-3 shadow-xl">
                                <Image src={getGemColorImage(color)} alt={`${color} gem`} width={144} height={144}
                                  className="rounded object-cover" style={{ minWidth: '144px', minHeight: '144px' }}
                                />
                              </div>
                            </div>
                          )}
                  ...
                  <div>
                    ...
                    <input
                      type="number" value={editingProduct.originalPrice || ''} onChange={(e) => setEditingProduct({ ...editingProduct, originalPrice: Number(e.target.value) || undefined })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"

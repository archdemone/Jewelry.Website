	...
	return (
		<div className="space-y-4">
			...
			<div className="flex gap-2">
				{nextCursor && (
					<a className="underline" href={`/admin/audit?cursor=${nextCursor}`}>Next</a>
				)}
			</div>
		</div>
	)

		...
		<>
			...
			<main className="container py-10">
				<section className="prose prose-sm max-w-none">
					...
					<p><em>Last updated: 2025-01-01</em></p>
					...
					<p>We use cookies for essential functionality and analytics. Manage preferences via the cookie banner.</p>
					...
					<h2>Your Rights</h2>
					<p>Depending on your location, you may have rights to access, correct, or delete your data (GDPR/CCPA).</p>
					<h2>Contact</h2>

		...
		<>
			...
			<main className="container py-10">
				<section className="prose prose-sm max-w-none">
					...
					<p>We strive for accuracy; errors may occur. We reserve the right to correct information.</p>
					...
					<p>We are not liable for indirect or consequential damages to the maximum extent permitted.</p>
					<h2>Governing Law</h2>

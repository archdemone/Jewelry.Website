		...
		<>
			...
			<main className="container py-10">
				<section className="prose prose-sm max-w-none">
					...
					<p>Orders are processed within 1–2 business days. Custom pieces may require additional time.</p>
					<h2>Methods & Costs</h2>
					...
					<h2>Restrictions</h2>
					<p>We cannot ship to P.O. Boxes in some regions. Hazardous materials restrictions may apply.</p>
				</section>
			</main>
			<Footer />
		</>

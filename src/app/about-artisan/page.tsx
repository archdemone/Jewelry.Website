            ...
            >
              <div className="mb-6 rounded-r-lg border-l-4 border-amber-400 bg-amber-50 p-6">
                <p className="mb-0 font-medium text-amber-900">
                  🌟 <strong>New Business Alert:</strong> We've just opened our doors! As a brand
                  new venture, we're committed to learning, growing, and providing the best possible
                  experience for our customers. Your patience and feedback help us improve every
                  day.
                </p>
              </div>
              ...
              <p className="leading-relaxed text-gray-700">
                ...
                someone who discovered a passion for creating beautiful rings and decided to turn
                that passion into something meaningful. While I may not have formal training, I pour
                my heart into every piece I make, constantly learning and striving to deliver the
                best quality I can.
              </p>

              <p className="leading-relaxed text-gray-700">
                My goal is simple:{' '}
                <strong>make beautiful, quality rings affordable for everyone</strong>. I believe
                that marking life's special moments shouldn't require spending a fortune, and by
                working from my home workshop and selling directly to you, I can offer prices
                significantly lower than traditional jewelers.
              </p>
            </motion.div>
          </div>
        </section>
              ...
              >
                ...
                <div className="flex-grow rounded-lg border-2 border-green-300 bg-gradient-to-r from-green-50 to-emerald-50 p-6 shadow-md">
                  ...
                  <p className="text-gray-700">
                    ...
                    that can support me while bringing joy to others through affordable, handcrafted
                    rings.
                  </p>
          ...
          <div className="container max-w-5xl">
            ...
            >
              ...
              <p className="mx-auto max-w-2xl text-lg text-gray-600">
                No fancy studio, no industrial equipment—just dedication, basic tools, and a corner
                of my bedroom transformed into a creative space
              </p>
            </motion.div>
          ...
          <div className="container max-w-5xl">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              >
                ...
                <p className="text-gray-600">
                  I source materials as locally as possible and I'm always transparent about what
                  goes into your ring. Ask me anything about the materials, process, or origins—I
                  believe in complete honesty.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  I'm not perfect, but I'm dedicated to getting better with every ring. Your
                  feedback is invaluable—it helps me grow as an artisan and ensures each piece is
            ...
            >
              ...
              <div className="mx-auto max-w-2xl rounded-xl bg-white p-8 shadow-lg">
                ...
                <p className="leading-relaxed text-gray-600">
                  This business venture has been officially approved and is actively supported by
                  our local council district. Their belief in this project and ongoing assistance
                  has been instrumental in turning a bedroom workshop dream into a legitimate
                  business. This support ensures we operate with full compliance and community
                  backing.
                </p>
          ...
          <div className="container max-w-3xl">
            ...
            >
              ...
              <p className="mb-4 leading-relaxed text-gray-700">
                Thank you for taking the time to read my story. Every ring I create carries a piece
                of my journey—from the early days of experimentation to finding purpose through
                adversity. When you wear one of my rings, you're not just wearing jewelry; you're
                carrying a symbol of resilience, hope, and the belief that beautiful things can
                emerge from humble beginnings.
              </p>
              <p className="mb-4 leading-relaxed text-gray-700">
                This business is brand new, and I'm learning every day. There might be bumps along
                the way, but I promise to always be honest, responsive, and committed to making
                things right. Your support means more than you know—it's not just buying a ring,
                it's believing in someone's fresh start.
              </p>

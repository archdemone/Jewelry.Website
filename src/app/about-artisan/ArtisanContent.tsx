  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[55vh] min-h-[480px] overflow-hidden bg-gradient-to-br from-stone-100 to-stone-200">
              ...
              <Image src="/images/artisan/bedroom-workshop-hero.jpg"
      ...
      <section className="bg-stone-50 py-10">
            ...
            <motion.div initial={{ opacity: 0, x: -30 }}              whileInView={{ opacity: 1, x: 0 }}              viewport={{ once: true }} className="flex items-start gap-6">
              ...
              <Image src="/images/artisan/early-work-2015.jpg"
            ...
            <motion.div initial={{ opacity: 0, x: 30 }}              whileInView={{ opacity: 1, x: 0 }}              viewport={{ once: true }} className="flex items-start gap-6">
              ...
              <div className="mt-4">
              <div className="relative h-48 w-full overflow-hidden rounded-lg">
              <Image src="/images/artisan/first-inlay-rings-2020.jpg"
      ...
      <section className="bg-white py-10">
            ...
            >
              ...
              <Image src="/images/artisan/bedroom-workshop-1.jpg"
            ...
            >
              <div className="relative h-64 w-full overflow-hidden rounded-lg shadow-lg">
              <Image src="/images/artisan/workshop-tools.jpg"

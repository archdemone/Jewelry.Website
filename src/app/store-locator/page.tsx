...
const stores = [
	{ id: 'nyc', name: 'Aurora Flagship', address: '123 Fifth Ave, New York, NY', phone: '(212) 555-1234', hours: 'Mon–Sat 10–7', services: ['Piercing', 'Repairs'] },
	...
	return (
		<>
			...
			<main className="container py-10">
				<h1 className="font-[var(--font-serif)] text-3xl font-semibold text-secondary">Store Locator</h1>
						...
						<ul className="mt-4 space-y-3">
							{stores.map(s => (
								<li key={s.id} className="rounded-md border p-3 text-sm">
									...
									<div className="mt-1 text-xs text-gray-500">Services: {s.services.join(', ')}</div>
									<a href={`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(s.address)}`} className="mt-2 inline-block text-secondary underline">Directions</a>
								</li>
							))}
						</ul>
					</aside>

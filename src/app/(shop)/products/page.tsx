    ...
    <>
      <main className="container py-10">
        <div className="mb-8 text-center">
          <h1 className="mb-4 text-4xl font-[var(--font-serif)] font-semibold text-secondary">
            Handcrafted Rings
          </h1>
          <p className="mx-auto max-w-2xl text-lg text-gray-600">
            Each ring is personally crafted from start to finish using locally-sourced materials. No
            mass production, no teams – just one artisan&apos;s dedication to your perfect ring.
          </p>
        </div>
        <form className="mt-6 grid grid-cols-1 items-end gap-3 rounded-lg border p-4 md:grid-cols-5">
          ...
          <div className="md:col-span-5">
            <button className="rounded-md bg-secondary px-4 py-2 text-sm text-white">
              Apply Filters
            </button>
          </div>
        </form>
            ...
            return (
              ...
              >
                ...
                <div className="text-sm text-gray-600">
                  {p.material} • {p.gemstones || 'No stones'}
                </div>
